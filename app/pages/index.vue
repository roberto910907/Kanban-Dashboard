        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            ...
            <div class="relative py-16 px-6 sm:py-24 lg:py-32 lg:px-8">
              ...
              >
                <span class="block text-white">Kanban workflow management</span>
                <span class="block text-indigo-200">has never been easier</span>
              </h1>
              <p
                class="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl"
              >
                Organize your work and keep track of all your pending task in a
                single place.
              </p>
              <div
              ...
              >
                ...
                >
                  ...
                  <a
                    href="https://docs.kanbandash.com"
                    target="_blank"
